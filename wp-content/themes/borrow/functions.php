...
function borrow_scripts() {
    ...
    wp_enqueue_style( 'borrow-font-awesome', get_template_directory_uri().'/css/font-awesome/css/font-awesome.min.css');
	...
	wp_enqueue_script( "borrow-map", "$protocol://maps.googleapis.com/maps/api/js?key=$gmap_api",array('jquery'), '20151228',true);
 ...
 * Customizer Menu.
 */
require get_parent_theme_file_path( '/framework/wp_bootstrap_navwalker.php' );
/**
 * Customizer images.
 */
require get_parent_theme_file_path( '/framework/BFI_Thumb.php' );	
